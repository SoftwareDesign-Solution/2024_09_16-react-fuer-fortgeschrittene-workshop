        ...
        <nav className="flex justify-between p-4 border-b-2 border-gray-300">
			...
			<div className="flex gap-2 justify-center">
				<div className="flex gap-1 justify-center">
					...
					<span className="cart-quantity inline-flex items-center rounded-md bg-blue-50 px-2 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10">0</span>
				</div>
